#import "UIBezierPath+MXBZSVGString.h"
static void MXBZSVGApplier(void* info, const CGPathElement* element);
...
- (NSString*)mxbz_SVGString
{
    ...
    CGPathApply(path, (__bridge_retained void*)SVGString, MXBZSVGApplier);
    NSString *lineCap;
