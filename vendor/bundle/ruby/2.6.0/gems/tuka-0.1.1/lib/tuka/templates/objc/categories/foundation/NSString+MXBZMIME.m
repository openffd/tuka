#import "NSString+MXBZMIME.h"

@implementation NSString (MXBZMIME)
- (NSString *)mxbz_MIMEType {
    return [[self class] mxbz_MIMETypeForExtension:[self pathExtension]];
}

+ (NSString *)mxbz_MIMETypeForExtension:(NSString *)extension {
    return [[self mxbz_MIMEDict] valueForKey:[extension lowercaseString]];
}
